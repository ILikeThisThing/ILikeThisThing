...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('Tags').insert([{tag: 'Dark/macabre'}, {tag: 'Absurdist'}, {tag: 'Existential'},
    	...
    	{tag: 'Adventure'}, {tag: 'Comedy'}, {tag: 'Crime'}, {tag: 'Fantasy'}, {tag: 'Horror'}, {tag: 'Musical'}, {tag: 'Mystery'},
    	{tag: 'Political'}, {tag: 'Romance'}, {tag: 'Satire'}, {tag: 'Science Fiction'}, {tag: 'Thriller'}, {tag: 'Western'}, {tag: 'So-Bad-its-Good'}]),
  );
};
