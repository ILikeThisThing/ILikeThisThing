...
exports.seed = function(knex, Promise) {
  ...
  //   knex('WorkTag').del(), 
    ...
    knex('Tags').insert([{tag: 'Theme-Dark/macabre'}, {tag: 'Theme-Absurdist'}, {tag: 'Theme-Existential'},
      ...
      {tag: 'Setting-Space Station'}, {tag: 'Setting-Europe'}, {tag: 'Setting-Asia'}, {tag: 'Setting-North America'}, {tag: 'Setting-South America'}, {tag: 'Setting-Australia'}, {tag: 'Antarctica'},
