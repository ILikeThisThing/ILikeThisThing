...
exports.seed = function(knex, Promise) {
  ...
  //   knex('WorkTag').del(), 
    ...
    knex('Tags').insert([{tag: 'Theme-Dark/macabre'}, {tag: 'Theme-Absurdist'}, {tag: 'Theme-Existential'},
    	...
    	{tag: 'Genre-Thriller'}, {tag: 'Genre-Western'}, {tag: "So-Bad-it's-Good"}, {tag: "Theme-Philosophy"}, {tag: "Theme-Programming"}, {tag: "Time Period-Time Travel"},
      ...
      {tag: 'Characters-Unreliable Narrator'}, {tag: 'Characters-Morally Complex'}, {tag: 'Time Period-Distant Future'}, {tag: 'Time Period-Near Future'}])
  ).catch(function(err){
